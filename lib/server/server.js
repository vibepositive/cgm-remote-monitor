...
require('./bootevent')(env, language).boot(function booted (ctx) {
    ...
    // Optional read-only monitoring endpoint for daily Trio/Nightscout analysis.
    // The route is inert until MONITOR_BRIDGE_KEY and MONITOR_NIGHTSCOUT_TOKEN are configured.
    app.use('/monitor', require('./monitorbridge')(env));
